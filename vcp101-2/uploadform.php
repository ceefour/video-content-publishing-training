...
<link type="text/css" rel="stylesheet" href="plupload/js/jquery.ui.plupload/css/jquery.ui.plupload.css" media="screen" />
					...
					<div class="Xupload-right">
							...
							setInterval(function() {
								if (videoId) {
									$.ajax({
										...
										if (data) {
											$('#videoId').text(data.id);
											$('#statusText').text(data.progresstext);
											$('#progressSub').text(data.progresssub + '%')
												.attr('aria-valuenow', data.progresssub)
												.css('width', data.progresssub + '%');
											$('#progressTotal').text(data.progress + '%')
						...
						<form class="form-horizontal">
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-2 control-label">Video ID</label>
								<div class="col-sm-10">
									<span id="videoId">Not yet started</span>
								</div>
							</div>
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-2 control-label">Status</label>
								<div class="col-sm-10">
									<span id="statusText">Not yet started</span>
								</div>
							</div>
							<div class="form-group">
								<label for="inputPassword3" class="col-sm-2 control-label">Current progress</label>
								<div class="col-sm-10">
									<div id="progressSub" class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 0%;">
										0%
									</div>
								</div>
							</div>
							<div class="form-group">
								<label for="inputPassword3" class="col-sm-2 control-label">Total progress</label>
								<div class="col-sm-10">
									<div id="progressTotal" class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 0%;">
										0%
									</div>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<a id="resultLink">Not yet completed</span>
								</div>
							</div>
						</div>
						</form>
