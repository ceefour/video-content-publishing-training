...
// $video  = $handle->fetch(\PDO::FETCH_OBJ);
...
<link href="css/style.css" rel='stylesheet' type='text/css' media="all" />
    ...
    <script>
    //console.info('jquery load');
    videoId = <?php echo json_encode($_GET['id']) ?>;
				...
				<div class="col-sm-8 single-left">
					<div class="song">
						...
						<div class="video-grid">
                            ...
                            <div class="flowplayer" data-autoplay="false">
                                <video>
                                    <source type="application/x-mpegurl" src="processed/<?php echo $videoId ?>/master.m3u8">
                                </video>
                            </div>
                            
                            <p>
                                <a href="processed/<?php echo $videoId ?>/audio.mp3">Download audio</a>
                            </p>
