...
$handle = $mysql->prepare('SELECT * FROM video WHERE progress=100');
$handle->execute();

$videos = $handle->fetchAll(\PDO::FETCH_OBJ);
...
<style type="text/css">
.resent-grid a img { height: 150px; }
</style>
			...
			<div class="main-grids">
				...
				<div class="recommended">
					<div class="recommended-grids">
						...
						<?php //$video = ['id' => 'DPR_RI_KOMISI_V_BERI_CATATAN_TERKAIT_MUDIK_2017']; ?>
						<?php foreach ($videos as $video): ?>
						<div class="col-md-3 resent-grid recommended-grid">
							<div class="resent-grid-img recommended-grid-img">
								<a href="show.php?id=<?php echo $video->id ?>"><img src="processed/<?php echo $video->id ?>/thumbnail.jpg" alt="" /></a>
							...
							<div class="resent-grid-info recommended-grid-info video-info-grid">
								<h5><a href="show.php?id=<?php echo $video->id ?>" class="title"><?php echo $video->id ?></a></h5>
								<ul>
									<li><p class="author author-info"><a href="#" class="author">DPR RI</a></p></li>
									<li class="right-list"><p class="views views-info"><?php echo $video->playcount ?> views</p></li>
								</ul>
							</div>
						</div>
						<?php endforeach; ?>
